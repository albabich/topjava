...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 13, 0), "Обед", 500, 1),
            ...
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 13, 0), "Обед2", 500, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 20, 0), "Ужин2", 410, 2)
            );
